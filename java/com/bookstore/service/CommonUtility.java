...
public class CommonUtility {
	...
	public static void showSuccessfulMessageFrontend(String successfulMessage,HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		forwardToPage("frontend/successfulMessage.jsp", successfulMessage, request, response);
	}
